    ...
    <div className="p-6 bg-white rounded-lg shadow-xl">
      <div className="p-6 mt-4 text-white rounded-t-lg bg-gradient-to-r from-[#0A66C2] to-[#1F2937]">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold">Thương hiệu lớn tiêu biểu cùng lĩnh vực</h2>
          <span className="px-2 py-1 text-xs font-bold text-[#FF8A00] bg-[#FFFAF0] rounded">Pro Company</span>
        </div>
        <p className="mt-1 text-sm text-white/80">Những thương hiệu tuyển dụng đã khẳng định được vị thế trên thị trường.</p>
      </div>
        ...
        {relatedCompanies.slice(0, 10).map((company, index) => (
          ...
          >
            ...
            <div className="w-full overflow-hidden text-sm">
              <h3 className="text-sm font-semibold truncate text-[#1F2937]">{company.name}</h3>
