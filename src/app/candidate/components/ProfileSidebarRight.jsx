      ...
      <div className="p-6 mb-4 bg-white shadow rounded-xl">
        <div className="mb-4">
          ...
          <div className="w-full h-3 mb-2 bg-gray-200 rounded-full">
            <div
              className="h-3 bg-[var(--color-primary-main)] rounded-full"
              style={{ width: "85%" }}
            ></div>
          </div>
          ...
          <div className="mb-2 text-xs text-gray-500">
            Complete profile to{" "}
            <span className="font-bold text-[var(--color-primary-main)]">
              70%
            </span>{" "}
          ...
          <button className="w-full py-2 text-sm font-bold text-white bg-[var(--color-primary-main)] rounded">
            Preview & Download CV
          </button>
        </div>
      </div>
