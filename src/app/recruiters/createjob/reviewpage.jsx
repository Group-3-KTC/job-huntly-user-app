  ...
  const submitJob = async () => {
    ...
    if (!datePostISO || !expiredDateISO) {
      dispatch(
        addToast({
          title: "Missing Dates",
          description: "Please select both post date and expiration date.",
          variant: "destructive",
        })
      );
      setIsLoading(false);
  ...
  const handleSubmit = () => {
    ...
    if (reviewData.datePost && reviewData.expiredDate) {
      ...
      if (expiredDate <= postDate) {
        newExpiredDateError = "Expiration date must be after the post date.";
        isValid = false;
      }
    }
    ...
    if (!isValid) {
      dispatch(
        addToast({
          ...
          description: "Please correct the date errors before publishing.",
          variant: "destructive",
        })
      );
      return;
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <Button variant="ghost" onClick={onReturn} className="p-2">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 text-gray-600">
                        <div className="flex items-center gap-1">
                          ...
                          <span>{formData.city.join(", ")}</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <Clock className="w-4 h-4" />
                          <span>{safeWorkType.join(", ")}</span>
                        </div>
                    ...
                    {formData.niceToHaves
                      ...
                      .map((niceToHave, index) => (
                        <div key={index} className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">{niceToHave}</span>
                        </div>
                      ))}
                  </div>
                </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">{safeWorkType.join(", ")}</span>
                </div>
                <div className="flex justify-between items-center">
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Your job listing has been successfully published to the API.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
